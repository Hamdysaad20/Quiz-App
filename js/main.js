//======== Start My App
	(function(){
		...
		const [instructions, quiz, selectBox, questionsCount, questionParent, message, button, bottomBar, bulletsParent, countDown ] = 
			  [document.querySelector('.instructions'), document.querySelector('.quiz-app'), document.querySelector('select'), document.querySelector('.questions-count span'), document.querySelector('.question'), document.querySelector('.message'), document.querySelector('button'), document.querySelector('.bottom-bar'), document.querySelector('.bullets'), document.querySelector('.count') ];

		//========== Main Vars .	  
		let decreNum  = 0, score = 0, questionNumber, correctAnswer, totalTime, interv, time = totalTime;
